...
const Course = (props) => {
    ...
    return (
        <div className='card bg-base-100 shadow-xl my-12'>
            <div className='h-36 bg-blue-900 flex justify-center items-center'><h4 className='text-4xl text-white'>{courseTitle}</h4></div>
            ...
            <h2  onClick={()=>handleCourseDetails(_id)} className='text-2xl font-bold my-3'>{courseName}</h2>
